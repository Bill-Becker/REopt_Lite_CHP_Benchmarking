...
df2 = pd.concat([df, count_storage_option, count_tech_option], axis = 1) 
#axis = 1 joins df to dfDispatch by adding columns df['reopt_seconds'][(df['chp_size']>1)]

#solve times by tech count
time_1tech = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_tech_option == 1)]
time_2tech = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_tech_option == 2)]
time_3tech = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_tech_option == 3)]
time_4tech = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_tech_option == 4)]
time_5tech = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_tech_option == 5)]


#solve times for runs with storage in the tech options
time_1storage = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_storage_option == 1)]
time_2storage = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_storage_option == 2)]
time_3storage = df2.reopt_seconds[(df2.status == 'optimal') & (df2.count_storage_option == 3)]
time_CWTES = df2.reopt_seconds[(df2.status == 'optimal') & (df2.CWTES_max_gal > 0) & (df2.HWTES_max_gal == 0) & (df2.bess_max_kwh == 0)]
time_HWTES = df2.reopt_seconds[(df2.status == 'optimal') & (df2.CWTES_max_gal == 0) & (df2.HWTES_max_gal > 0) & (df2.bess_max_kwh == 0)]
time_bothTES = df2.reopt_seconds[(df2.status == 'optimal') & (df2.CWTES_max_gal > 0) & (df2.HWTES_max_gal > 0) & (df2.bess_max_kwh == 0)]
time_BESS_CWTES = df2.reopt_seconds[(df2.status == 'optimal') & (df2.CWTES_max_gal > 0) & (df2.HWTES_max_gal == 0) & (df2.bess_max_kwh > 0)]
time_BESS_HWTES = df2.reopt_seconds[(df2.status == 'optimal') & (df2.CWTES_max_gal == 0) & (df2.HWTES_max_gal > 0) & (df2.bess_max_kwh > 0)]
